...
contract ELTToken is StandardTokenExt {
    ...
    function ELTToken(address _owner, string _name, string _symbol, uint _totalSupply, uint _decimals, uint _releaseFinalizationDate, address _initialVersion) public {
        name = _name;
        symbol = _symbol;
